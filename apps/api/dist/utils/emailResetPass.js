...
const sendResetEmail = (emailTo, subject, content, data) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const urlLink = `http://localhost:3000/reset-password/${data === null || data === void 0 ? void 0 : data.token}`;
